...
public class PortfolioService {
    ...
    public PortfolioEntity createOrUpdatePortfolio(Long userId, PortfolioEntity portfolio) {
        ...
        if (userOpt.isPresent()) {
            ...
            if (portfolio.getStartTime() == null || portfolio.getEndTime() == null) {
                throw new RuntimeException("Start time and end time must be set.");
            }
    ...
    public PortfolioEntity updatePortfolio(Long userId, PortfolioEntity portfolio) {
        ...
        if (existingPortfolio.isPresent()) {
            ...
            // Update the portfolio-wide fields (daysAvailable, startTime, and endTime)
            updatedPortfolio.setDaysAvailable(portfolio.getDaysAvailable());
            updatedPortfolio.setStartTime(portfolio.getStartTime());
            updatedPortfolio.setEndTime(portfolio.getEndTime());
