...
} from "./chunk-HMGR26PV.js";
import {
  Popper_default
} from "./chunk-VUO4DCWH.js";
import {
  shouldForwardProp,
  useRtl
} from "./chunk-B5GVBT46.js";
import {
  CartesianProvider,
  DEFAULT_X_AXIS_KEY,
  DEFAULT_Y_AXIS_KEY,
  ...
  useSvgRef,
  useTicks
} from "./chunk-YEDCBGXN.js";
import {
  warnOnce
} from "./chunk-HJ33EGMF.js";
import {
  Typography_default
} from "./chunk-R4DWZOLB.js";
import {
  useThemeProps
} from "./chunk-GZHQMIUO.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-GDGBM5H6.js";
import {
  useTheme
} from "./chunk-MTRNGTOX.js";
import {
  composeClasses,
  exactProp,
...
} from "./chunk-KZXDNBOY.js";
import {
  useForkRef
} from "./chunk-6PIWFOKA.js";
import {
  clsx_default
} from "./chunk-U7P2NEEE.js";
import {
  useEnhancedEffect_default
} from "./chunk-2ROIQWVH.js";
import {
  require_prop_types
} from "./chunk-O24A7XIP.js";
import {
  _extends
...
function ChartsText(props) {
  ...
  const wordsByLines = React4.useMemo(() => getWordsByLines({
    style,
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React11.useContext(ZAxisContext);
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React13.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React13.useMemo(() => {
...
var InteractionContext = React15.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React15.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React15.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function LegendPerItem(props) {
  ...
  const labelStyle = React20.useMemo(
  ...
  const padding = React20.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React20.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React20.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React20.useMemo(() => {
...
var _excluded7 = ["drawingArea", "seriesToDisplay", "hidden", "onItemClick"];
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
    ...
    itemId: import_prop_types10.default.oneOfType([import_prop_types10.default.number, import_prop_types10.default.string]),
    label: import_prop_types10.default.string.isRequired,
    maxValue: import_prop_types10.default.oneOfType([import_prop_types10.default.instanceOf(Date), import_prop_types10.default.number]),
    minValue: import_prop_types10.default.oneOfType([import_prop_types10.default.instanceOf(Date), import_prop_types10.default.number]),
...
function ChartsLegend(inProps) {
  ...
  const {
    slots,
    slotProps
  } = defaultizedProps, other = _objectWithoutPropertiesLoose(defaultizedProps, _excluded8);
  const theme = useTheme();
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types12.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types12.default.oneOfType([import_prop_types12.default.number, import_prop_types12.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types12.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types12.default.number,
  /**
...
var _excluded9 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter", "onItemClick"];
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default false
   */
  hideFirst: import_prop_types13.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types13.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types13.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React28.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React29.forwardRef(function ChartsSurface2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiChartsSurface"
  });
...
// node_modules/@mui/x-charts/ChartContainer/useChartContainerProps.js
var _excluded11 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children", "skipAnimation"];
...
function AnimationProvider(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
var ChartContainer = React37.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime24.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime24.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime24.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime24.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime24.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime24.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime24.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime24.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime24.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
true ? ChartContainer.propTypes = {
   ...
   */
  plugins: import_prop_types16.default.arrayOf(import_prop_types16.default.object),
  /**
...
var _excluded12 = ["width", "height", "resolveSizeBeforeRender", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis", "skipAnimation"];
...
var ResponsiveChartContainer = React39.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime25.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types17.default.arrayOf(import_prop_types17.default.object),
  /**
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types17.default.arrayOf(import_prop_types17.default.shape({
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types17.default.arrayOf(import_prop_types17.default.shape({
    classes: import_prop_types17.default.object,
    colorMap: import_prop_types17.default.oneOfType([import_prop_types17.default.shape({
      colors: import_prop_types17.default.arrayOf(import_prop_types17.default.string).isRequired,
      type: import_prop_types17.default.oneOf(["ordinal"]).isRequired,
...
//# sourceMappingURL=chunk-Z7LLLEW7.js.map
